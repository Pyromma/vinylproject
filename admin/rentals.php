            ...
            <div class="search-tab-result"  style="width:100%">
                <div id="search-tab-search">
                    <div id="search-tab-search-container">
                        ...
                        <button type="submit" id="search-rentals"><i class="fa fa-search"></i></button>
                    </div>
                </div>
